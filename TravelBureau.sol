...
contract TravelBureau is Ownable, ReentrancyGuard, TimeLock {
    ...
    uint256 public constant INITIAL_EMISSION_RATE = 40e18;
    // Minimum emission rate
    uint256 public constant MINIMUM_EMISSION_RATE = 5e18;
    ...
    function checkSupplyReaching() public view returns (bool) {
        uint256 toleratedSupply = tropical.maximumSupply().mul(1).div(10000);
        return tropical.totalSupplyAndBurnt() >= toleratedSupply;
    }
